...
function launch_emulator () {
  ...
  options="@${emulator_name} -no-window -no-snapshot -noaudio -no-boot-anim -memory 4096 ${hw_accel_flag} -camera-back none"
...
function check_emulator_status () {
  ...
  while true; do
    ...
    if [ "$result" == "1" ]; then
      ...
      ./katalonc -noSplash -runMode=console -projectPath="/katalon_sample_prj/Android Mobile Tests with Katalon Studio.prj" -retry=0 -testSuitePath="Test Suites/Smoke Tests for API Demos App" -browserType="Android" -deviceId="emulator-5554" -executionProfile="local" -apiKey="2b233a8b-743d-44bd-8e85-dc990101c95e"
